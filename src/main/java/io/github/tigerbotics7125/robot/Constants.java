...
public class Constants {
	...
	public static final Pose2d kExampleTargetPose = new Pose2d(16.4846 / 2.0, 8.1026 / 2.0, new Rotation2d()); // center
														   // of
														   // field
	...
	public static final double kPositionConversionFactor = 1.0 / kGearRatio; // input
										 // rotations
										 // to
										 // output
										 // rotations.
	public static final double kVelocityConversionFactor = 1.0 / kGearRatio; // input
										 // RPM
										 // to
										 // output
										 // RPM.
