...
public class Constants {
	...
	public static class Drivetrain {
		...
		// Characteristics
		// meters / second
		public static final double kMaxTranslationVelocity = Units.feetToMeters(15.6);
		// radians / second
		public static final double kMaxThetaVelocity = 3.0 * Math.PI / 2.0;
